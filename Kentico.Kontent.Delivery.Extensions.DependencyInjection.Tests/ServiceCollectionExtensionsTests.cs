...
namespace Kentico.Kontent.Delivery.Extensions.DependencyInjection.Tests
{
    public class ServiceCollectionExtensionsTests
    {
        ...
        [Fact]
        public void AddDeliveryClientFactoryWithOptions_ReturnsNoNamedClientNull()
        {
            _serviceCollection.AddDeliveryClient("named", new DeliveryOptions { ProjectId = ProjectId });
            var provider = _serviceCollection.BuildServiceProvider();
            var deliveryClientFactory = provider.GetRequiredService<IDeliveryClientFactory>();

            var deliveryClient = deliveryClientFactory.Get();

            Assert.Null(deliveryClient);
        }

        [Theory]
        [InlineData(CacheTypeEnum.Memory)]
        [InlineData(CacheTypeEnum.Distributed)]
        public void AddDeliveryNamedClient_CacheWithDeliveryCacheOptions_ReturnsNamedDeliveryClient(CacheTypeEnum cacheType)
        {
        ...
        [InlineData(CacheTypeEnum.Memory)]
        [InlineData(CacheTypeEnum.Distributed)]
        public void AddDeliveryNamedClient_CacheWithDeliveryCacheOptions_ReturnsNull(CacheTypeEnum cacheType)
        {
            _serviceCollection.AddDeliveryClient("named", new DeliveryOptions() { ProjectId = Guid.NewGuid().ToString() });
            _serviceCollection.AddDeliveryClientCache("named", new DeliveryCacheOptions()
            {
        ...
        [InlineData(CacheTypeEnum.Memory)]
        [InlineData(CacheTypeEnum.Distributed)]
        public void AddDeliveryNamedClient_CacheWithDeliveryCacheOptions_RetunsNoNamedClientNull(CacheTypeEnum cacheType)
        {
            _serviceCollection.AddDeliveryClient("named", new DeliveryOptions() { ProjectId = Guid.NewGuid().ToString() });
            _serviceCollection.AddDeliveryClientCache("named", new DeliveryCacheOptions()
            {
        ...
        [InlineData(CacheTypeEnum.Memory)]
        [InlineData(CacheTypeEnum.Distributed)]
        public void GetNamedDeliveryCacheManager_WithCorrectName_ReturnsDeliveryClient(CacheTypeEnum cacheType)
        {
            _serviceCollection.AddDeliveryClient("named", new DeliveryOptions() { ProjectId = Guid.NewGuid().ToString() });
            _serviceCollection.AddDeliveryClientCache("named", new DeliveryCacheOptions()
            {
        ...
        [InlineData(CacheTypeEnum.Memory)]
        [InlineData(CacheTypeEnum.Distributed)]
        public void AddDeliveryClient_CacheWithDeliveryCacheOptions_ReturnsNull(CacheTypeEnum cacheType)
        {
            _serviceCollection.AddDeliveryClient("named", new DeliveryOptions() { ProjectId = Guid.NewGuid().ToString() });
            _serviceCollection.AddDeliveryClientCache("named", new DeliveryCacheOptions()
            {
